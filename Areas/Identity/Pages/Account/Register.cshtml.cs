...
namespace OnlineLearningPlatformGroup5.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        private readonly SignInManager<IdentityUser> _signInManager;
        //Role manager is added
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(30, ErrorMessage = "The username must be at least {2} and at max {1} characters long.", MinimumLength = 2)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Role Db values are initiliazed in case no role is defined in the DB
